...
import 'package:quiz_app/screens/answers_button.dart';
...
class _QuestionScreenState extends State<QuestionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final answerPadding = EdgeInsets.symmetric(
      vertical: (maxAnswerOptions - currentAnswers.length) * 10.0, // Adjust the factor as needed
    );
        ...
        child: Column(
          ...
          children: [
            ...
            ...currentQuestion.answers.map((answer) {
              final isSelected =
                  selectedAnswers[currentQuestionIndex] == answer;
                  return Padding(padding:answerPadding,
              child: AnswerButton(
                answerText: answer,
                selected: isSelected,
                onTap: () {
